...
activities = {
    ...
    "Basketball Club": {
        "description": "Develop basketball fundamentals and teamwork through practice games",
    ...
    "Science Club": {
        "description": "Conduct experiments and explore scientific topics with hands-on activities",
